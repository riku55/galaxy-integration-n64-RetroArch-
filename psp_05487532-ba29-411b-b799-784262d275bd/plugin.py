...
class Retroarch(Plugin):
    ...
    def __init__(self, reader, writer, token):
        super().__init__(Platform.PlayStationPortable, version, reader, writer, token)
        self.game_cache = []
        self.playlist_path = user_config.emu_path + "playlists/Sony - PlayStation Portable.lpl"
        self.proc = None
        self.game_run = ""
